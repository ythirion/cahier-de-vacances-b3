...
import static shift.Vertical.whichFloor;
import static org.assertj.core.api.Assertions.assertThat;

class VerticalShiftTest {
    @ParameterizedTest
    @CsvSource({
            "1, 0",
            "2, 3",
    ...
    private static String loadInstructionsFromFile(String input) throws URISyntaxException, IOException {
        return Files.readString(
                Path.of(Objects.requireNonNull(VerticalShiftTest.class.getClassLoader().getResource(input)).toURI())
        );
    }
}